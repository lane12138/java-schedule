...
@Component("huiyi3Job")
@Slf4j
public class HuiYi3Task {



    public static void main(String[] args) {
        HuiYi3Task HuiYiTask = new HuiYi3Task();
    ...
    public   void qiangHuiyishi(){
        ...
        String dayString = DateUtil.format(DateUtil.offsetDay(dateTime, Config3.day), "yyyy-MM-dd");
        ...
        //获取所有日期信息
        for (List<String> time : Config3.times) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            //3.添加会议室
            boolean  flag= huiTools.addHuiyishi(token, userId, riChengId, Config3.room.get(i));
